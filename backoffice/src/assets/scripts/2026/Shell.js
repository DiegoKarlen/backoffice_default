...
export const NAV = [
  ...
  {
    labelKey: "nav.areas.players",
    items: [
      {
        key: "admin-players",
        textKey: "nav.items.players",
        href: "admin-players.html",
        func: "bo.players.manage",
        icon:
          '<circle cx="12" cy="8" r="4"/><path d="M4 21c0-3 4-5 8-5s8 2 8 5"/>',
      },
    ],
      ...
      <div class="topbar-actions">
        ...
        <div class="dd-wrap">
          ...
          <div class="dd-menu dd-profile" role="menu">
            ...
            <a class="dd-menu-item" href="admin-security.html">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg>
              ${t("account.security")}
            </a>
